...
<template>
    <div>
        ...
        <ul>
            ...
            <li>
                <Paragraph>
                    <strong>Website</strong> refers to Avvy Ink, accessible from
                    <a href="https://avvy.ink" rel="external nofollow noopener" target="_blank">https://avvy.ink</a>
                </Paragraph>
            </li>
            <li>
                <Paragraph>
        ...
        <Heading size="1">Collecting and Using Your Personal Data</Heading>

        <Heading size="2">Types of Data Collected</Heading>

        <Heading size="3">Personal Data</Heading>
        ...
        <ul>
            ...
            <li>
                <Paragraph>Address, State, Province, ZIP/Postal code, City</Paragraph>
            </li>
            <li>
        ...
        <Heading size="3">Usage Data</Heading>
        ...
        <Heading size="3">Information from Third-Party Social Media Services</Heading>
        ...
        <Heading size="2">Use of Your Personal Data</Heading>
        ...
        <Heading size="2">Retention of Your Personal Data</Heading>
        ...
        <Heading size="2">Transfer of Your Personal Data</Heading>
        ...
        <Heading size="2">Delete Your Personal Data</Heading>
        ...
        <Heading size="2">Disclosure of Your Personal Data</Heading>

        <Heading size="3">Business Transactions</Heading>
        ...
        <Heading size="3">Law enforcement</Heading>
        ...
        <Heading size="3">Other legal requirements</Heading>
        ...
        <Heading size="2">Security of Your Personal Data</Heading>
        ...
        <Heading size="1">Links to Other Websites</Heading>
        ...
        <ul>
            <li>
                ...
                <a href="https://avvy.ink/docs/privacy" rel="external nofollow noopener" target="_blank">https://avvy.ink/docs/privacy</a>
            </li>
        </ul>
    </div>
</template>
