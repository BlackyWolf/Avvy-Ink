...
<template>
    <div>
        <Paragraph>This page is a general placeholder and not really meant for legal purposes.</Paragraph>

        <Heading size="1">Terms and Conditions</Heading>

        <Paragraph>Last updated: June 24, 2023</Paragraph>
        <Paragraph>Please read these terms and conditions carefully before using Our Service.</Paragraph>

        <Heading size="1">Interpretation and Definitions</Heading>

        <Heading size="2">Interpretation</Heading>
        ...
        <Heading size="2">Definitions</Heading>
        ...
        <ul>
            ...
            <li>
                <Paragraph><strong>Country</strong> refers to: Texas, United States</Paragraph>
            </li>
            <li>
                <Paragraph>
                    <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                    or &quot;Our&quot; in this Agreement) refers to Avvy Ink.
                </Paragraph>
            </li>
            <li>
                <Paragraph>
            ...
            <li>
                <Paragraph>
                    <strong>Website</strong> refers to Avvy Ink, accessible from <a href="https://avvy.ink"
                        rel="external nofollow noopener" target="_blank">https://avvy.ink</a>
                </Paragraph>
            </li>
            <li>
                <Paragraph>
        ...
        <Heading size="1">Acknowledgment</Heading>
        ...
        <Paragraph>You represent that you are over the age of 18. The Company does not permit those under 18 to use the Service.</Paragraph>
        <Paragraph>
        ...
        <Paragraph>Upon termination, Your right to use the Service will cease immediately.</Paragraph>
        ...
        <Heading size="1">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot; Disclaimer</Heading>
        ...
        <Heading size="1">Governing Law</Heading>
        ...
        <Heading size="1">Disputes Resolution</Heading>
        ...
        <Heading size="1">For European Union (EU) Users</Heading>
        ...
        <Heading size="1">United States Legal Compliance</Heading>
        ...
        <Heading size="1">Severability and Waiver</Heading>

        <Heading size="2">Severability</Heading>
        ...
        <Heading size="1">Translation Interpretation</Heading>
        ...
        <Heading size="1">Changes to These Terms and Conditions</Heading>
        ...
        <ul>
            <li>
                ...
                <a href="https://avvy.ink/tos" rel="external nofollow noopener" target="_blank">https://avvy.ink/tos</a>
            </li>
        </ul>
    </div>
</template>
